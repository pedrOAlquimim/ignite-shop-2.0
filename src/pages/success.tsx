...
import { Details, RoundedCardsContainer, SuccessContainer } from "../styles/pages/success";
  ...
  return (
    <SuccessContainer>
      ...
      <Details>
        ...
        <p>Uhuul <strong>{customerName}</strong>, sua compra de {orderQuantity} camiseta(s) já está a caminho da sua casa.</p>
      </Details>
